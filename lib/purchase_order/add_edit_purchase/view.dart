...
import 'package:asset_management_module/purchase_order/add_edit_purchase/add_items.dart';
import 'package:asset_management_module/purchase_order/add_edit_purchase/form_po.dart';
...
class AddEditPurchasePage extends StatelessWidget {
  const AddEditPurchasePage({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
      init: AddEditPurchaseController(),
      builder: (ctr) => Obx(() => Scaffold(
        appBar: AppBar(
          title: Text('${'add'.tr} ${'purchase_order'.tr}'),
