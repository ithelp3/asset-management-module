      ...
      builder: (ctr) => Scaffold(
        ...
        body: Obx(() => ScrollConfiguration(
          ...
          child: ListView(
            children: [
              ...
              ...ctr.suppliers.map((item) => RadioListTile(
                  ...
                  onChanged: (selected) {
                    ctr.selectedSupplier.value = selected as SubmissionSuppliers;
                  },
        ...
        bottomNavigationBar: Container(
          ...
          child: ElevatedButton(
              ...
              child: Text('send'.tr, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold),)
          ),
        ),
      )
    );
